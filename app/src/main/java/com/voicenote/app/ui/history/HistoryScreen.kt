    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(padding)) {
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("搜索标题、备注或内容", style = MaterialTheme.typography.bodySmall) },
...
@Composable
private fun HistoryVoiceRecordCard(record: VoiceRecord, onClick: () -> Unit, modifier: Modifier = Modifier) {
    ...
    val durationMinutes = record.endTime?.let { end ->
        java.time.Duration.between(record.startTime, end).toMinutes()
    } ?: 0
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Row {
                    Text(timeFormatter.format(record.startTime), style = MaterialTheme.typography.labelSmall, color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.5f))
